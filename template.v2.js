  ...
  <div class="byline grid">
    <div class="authors-affiliations grid">
      ...
      ${e.authors.map((e)=>`
        ...
        <p class="affiliation">
        ${e.affiliations.map((e)=>e.url?`<a class="affiliation" href="${e.url}">${e.name}</a>`:`<div class="affiliation">${e.name}</div>`).join(', ')}
        </p>
      `).join('')}
    </div>
    <div>
